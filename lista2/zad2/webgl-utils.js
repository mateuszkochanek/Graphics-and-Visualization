// Pisząc te klasy posiłkowałem się kursem https://webglfundamentals.org/

/*
    Klasa wspomagająca ładowanie shaderów i tworzenie z nich programu.
*/
class WebglUtils {
    ...
    static async createProgram(gl, vertexShaderSource, fragmentShaderSource) {
        ...
        var vertexShader = await WebglUtils.createShader(gl, gl.VERTEX_SHADER,vertexShaderSource);
        var fragmentShader = await WebglUtils.createShader(gl, gl.FRAGMENT_SHADER,fragmentShaderSource);
...
/*
    Klasa zawierająca wszelkiego rodzaju operacje na macierzach 4 wymiarowych,
    które mogłyby być potrzebne przy grafice 3d (jak i 2d).
*/
