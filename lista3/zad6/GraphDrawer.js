class GraphDrawer {
    constructor(canvas, vertexShaderSource, fragmentShaderSource) {
        ...
        this.translationLeft = [0, 0, 1000]
        this.translationRight = [0, 0, 1000]
        this.rotation = [0, 0, 0]
    ...
    translate(vx=0, vy=0, vz=0){
        this.translationLeft[0] += vx;
        this.translationLeft[1] += vy;
        this.translationLeft[2] += vz;
        this.translationRight[0] += vx;
        this.translationRight[1] += vy;
        this.translationRight[2] += vz;
    }
...
//__________________________________________________
        ...
        var target = [-5, -5, 0];
        var up = [0, 1, 0];
        var cameraMatrix = Matrix4.lookAt(this.translationLeft, target, up);
        ...
        //worldMatrix = Matrix4.translate(worldMatrix, 10, 10, 0);
...
//_____________________________________________________
        ...
        this.gl.uniform4f(this.colorLocation, 0.8, 0.8, 0.8, 0.8);
        ...
        var target = [5, 5, 0];
        var up = [0, 1, 0];
        var cameraMatrix = Matrix4.lookAt(this.translationRight, target, up);
