...
var sbx_makeShaderProgram= function(gl, faceInfos, cubeFace){
    /* Parameters:
       gl - WebGL context
    */
...
function sbx_loadTextures(gl, faceInfos, cubeFace){
...
function sbx_loadImage(source, i) {
    let image = new Image();
...
var sbx_drawSkybox= function ( gl, view, projection, boxFaceTextures ) {
